...
int main(int argc, char** argv) {
	std::string inputFile = "C:\\ConsoleApplication1\\photos2\\image9.jpg";
	...
	cv::dnn::Net inputNet = cv::dnn::readNetFromCaffe("C:\\ConsoleApplication1\\pose\\mpi\\pose_deploy_linevec.prototxt", "C:\\ConsoleApplication1\\pose\\mpi\\pose_iter_160000.caffemodel");
